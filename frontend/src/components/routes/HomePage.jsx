...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col-reverse space-y-15 md:flex-row items-center justify-center min-h-screen px-6  bg-gradient-to-r from-[#1a1a1a] via-[#2c0101] to-black pt-25 ">

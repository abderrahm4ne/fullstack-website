  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <img
        ...
        alt="Behind Right"
        className="absolute xl:w-[400px] xl:h-[680px] md:w-[300px] md:h-[500px] w-[230px] h-[550px] ml-8 object-cover rounded-xl shadow-md opacity-70 sm:mb-20"
      ...
      <img
        ...
        alt="Behind Left"
        className="absolute xl:w-[400px] xl:h-[680px] md:w-[300px] md:h-[500px] w-[230px] h-[550px] mr-8 object-cover rounded-xl shadow-md opacity-70 sm:mb-20"
        style={{rotate: "-3deg", boxShadow:"-6px -3px 10px #333333"}}
      />
      ...
      <img
        ...
        src={images[current]}
        alt="Main"
        className="relative xl:w-[400px] xl:h-[680px] md:w-[300px] md:h-[500px] w-[230px] h-[550px] object-cover rounded-xl shadow-lg sm:mb-20"

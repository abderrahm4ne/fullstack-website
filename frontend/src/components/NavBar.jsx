...
export default function NavBar() {
  ...
  return (
    <div className="flex flex-col ">
      ...
      <div className="w-full bg-secondary flex flex-row items-center py-3 xl:px-20 md:px-7 px-5  justify-between border-b">
        ...
        <div className="flex-1 flex justify-center">
          <div className="hidden sm:flex md:space-x-3.5 space-x-2">
            ...
            <NavLink to="home" className="font-bold routes font-routes brand-red xl:text-[1.2rem] sm:text-[1.1rem] text-[1rem]">HOME</NavLink>
      ...
      <div className="w-full bg-[#1b0000] text-white text-center py-4 text-xl font-routes">
        Nadzheee is Algerian an brand © 2025.
      </div>
